...
- (id)initWithURL:(NSURL *)url urlCookies:(NSArray*)cookies;
{
    return [self initWithURL:url protocols:nil urlCookies:cookies];
}

- (id)initWithURL:(NSURL *)url protocols:(NSArray *)protocols urlCookies:(NSArray*)cookies;
{
